...
#ifndef PSU_2016_ZAPPY_GUARDENOUGHSTONESONCELLFORINCANTATION_HPP
#define PSU_2016_ZAPPY_GUARDENOUGHSTONESONCELLFORINCANTATION_HPP
...
namespace ai
{
  struct GuardEnoughStonesOnCellForIncantation
  {
    template <class Fsm,class Evt,class SourceState,class TargetState>
    bool operator()(Evt const& , Fsm& fsm, SourceState& ,TargetState&)
    {
      std::cout << "GuardEnoughStonesOnCellForIncantation::on_guard()" <<  std::endl;
      std::cout << fsm.vision.front().content << std::endl;
