/*
** response_drop.c for PSU_2016_zappy in /home/montag-v/rendu/PSU_2016_zappy/server/srcs/parser/ai/response/response_drop.c
**
** Made by Montagne Valentin
** Login   <valentin.montagne@epitech.eu>
**
** Started on  Fri Jun 30 18:35:14 2017 Montagne Valentin
** Last update Fri Jun 30 18:35:14 2017 Montagne Valentin
*/
...
static bool		add_from_player_tile(t_map *map, t_player *player,
						t_ore ore)
{
  t_tile		*tile;
...
bool			response_drop(t_player *player, t_server *server)
{
  unsigned int		idx;
  char			*param;
  ...
  while (dico[idx])
  {
    ...
    {
      if (!add_from_player_tile(server->map, player, (t_ore)idx)
	  || !player->drop(player, (t_ore)idx))
