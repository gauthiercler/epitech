...
bool DroidMemory::operator==(const DroidMemory &otherMemory) const{
  return this->_exp == otherMemory._exp && this->_fingerPrint == otherMemory._fingerPrint;
}

bool DroidMemory::operator!=(DroidMemory const &otherMemory) const{
  return !operator==(otherMemory);
}

bool DroidMemory::operator<(DroidMemory const &otherMemory) const{
  return this->_exp < otherMemory._exp;
}
