...
** Last update Tue May  3 20:52:42 2016 Buyumad Anas
*/
...
void		add_to_list(t_list_depth **list, int x, int y)
{
  ...
  save = xmalloc(sizeof(t_list_depth));
  save->x = x;
  save->y = y;
  save->next = *list;
  *list = save;
...
void		add_pile(t_pile **list, t_pos pos, t_pos father, t_map_depth *map)
{
  t_pile	*save;
...
void		add_end_save(t_pile **p, t_pos pos, t_pile *father, t_map_depth *map)
{
  t_pile	*save;
