/*
** init_lldi.c for init in /home/gogo/rendu/CPE_2015_corewar/asm/srcs/initialization/init_arg
** 
** Made by Gauthier Cler
** Login   <cler_g@epitech.eu>
** 
** Started on  Tue Mar 22 21:35:09 2016 Gauthier Cler
** Last update Sat Mar 26 17:24:13 2016 Gauthier Cler
*/
...
{
  if ((instruction->name = my_strdup("lldi")) == NULL)
    return (ERROR);
