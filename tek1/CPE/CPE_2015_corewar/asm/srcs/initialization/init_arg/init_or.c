/*
** init_or.c for init in /home/gogo/rendu/CPE_2015_corewar/asm/srcs/initialization/init_arg
** 
** Made by Gauthier Cler
** Login   <cler_g@epitech.eu>
** 
** Started on  Tue Mar 22 21:29:51 2016 Gauthier Cler
** Last update Sat Mar 26 17:26:13 2016 Gauthier Cler
*/
...
{
  if ((instruction->name = my_strdup("or")) == NULL)
    return (ERROR);
